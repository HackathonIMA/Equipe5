...
<html>
<head>
<title>Hackaton 2016 - Four Limits</title>
				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" id="cbp-spmenu-s1">
					<div class="scrollbar scrollbar1">
						<ul class="nav" id="side-menu">
							...
							<li>
								<a href="#"><i class="fa fa-cogs nav_icon"></i>Solicitações Recentes</a>
							</li>
							<li>
								<a href="#"><i class="fa fa-book nav_icon"></i>Média de Espera</a>
								<!-- /nav-second-level -->
							</li>
							<li>
								<a href="#"><i class="fa fa-th-large nav_icon"></i>Média de atraso</a>
							</li>
							<li>
								<a href="#"><i class="fa fa-envelope nav_icon"></i>Atendimentos Medicos</a>
							</li>
						</ul>
					</div>
					<!-- //sidebar-collapse -->
		...
		<div class="sticky-header header-section ">
			...
			<div class="header-right">
				...
				<div class="logo">
					<a href="index.html">
						<ul>
							<li><img src="images/Logo_FourLimits.png" alt="" /></li>
							<div class="clearfix"> </div>
						</ul>
					</a>
				</div>
				...
				<div class="row four-grids">
					<div class="col-md-3 ticket-grid">
						<div class="tickets">
							...
							<div class="grid-right">
								<h3>Novas <span>Solicitações</span></h3>
								<p><?php echo $this->novasSolicitacoes; ?></p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="col-md-3 ticket-grid">
						<div class="tickets">
							...
							<div class="grid-right">
								<h3>Média de <span>espera</span></h3>
								<p><?php echo $this->mediaEspera; ?></p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="col-md-3 ticket-grid">
						<div class="tickets">
							...
							<div class="grid-right">
								<h3>Média de <span>atraso</span></h3>
								<p><?php echo $this->mediaAtraso; ?></p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div class="col-md-3 ticket-grid">
						<div class="tickets">
							...
							<div class="grid-right">
								<h3>Atendimentos <span>Médicos</span></h3>
								<p><?php echo $this->qtdAtendimentos; ?></p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					<div id="outerdiv">
						<div id="innerdiv">
							<iframe src="charts.html" height="700px" width="600px" border='0'> </iframe>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
		...
		<!--footer-->
		 <div class="dev-page">
            ...
            <div class="dev-page-footer dev-page-footer-fixed">
				...
				<div class="container">
					<div class="copyright">
						<p>© 2016 Four Limits. Design by <a href="http://fourlimits.com/">Four Limits</a></p>
					</div>
					<!-- page footer buttons -->
										<!-- //page footer buttons -->
